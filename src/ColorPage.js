            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="px-3 py-5 bg-primary text-white">.bg-gradient-primary</div>
                            <div class="px-3 py-5 bg-secondary text-white">.bg-gradient-secondary</div>
                            <div class="px-3 py-5 bg-success text-white">.bg-gradient-success</div>
                            <div class="px-3 py-5 bg-info text-white">.bg-gradient-info</div>
                            <div class="px-3 py-5 bg-warning text-white">.bg-gradient-warning</div>
                            <div class="px-3 py-5 bg-danger text-white">.bg-gradient-danger</div>
                            <div class="px-3 py-5 bg-light text-dark">.bg-gradient-light</div>
                            <div class="px-3 py-5 bg-dark text-white">.bg-gradient-dark</div>
                        </div>
                    </div>
